#This routine reads the data of outcome of DMFT+CTAUX and show the double occupancy at
# site with  stagering potential \lambda_x and -\lambda_x
...
U6, = plt.plot(U, double[:,1],'rs-',lw=2.5)

plt.plot(U, double[:,0],'rs--',lw=2.5)
...
U4, = plt.plot(U, double[:,1],'gs-',lw=2.5)

plt.plot(U, double[:,0],'gs--',lw=2.5)
...
U1, = plt.plot(U, double[:,1],'bs-',lw=2.5)

plt.plot(U, double[:,0],'bs--',lw=2.5)
...
U05, = plt.plot(U, double[:,1],'cs-',lw=2.5)

plt.plot(U, double[:,0],'cs--',lw=2.5)
...
U5, = plt.plot(U,double[:,1],'ms-',lw=2.5)

plt.plot(U, double[:,0],'ms--',lw=2.5)
...
plt.ylim(-0.1,0.9)
plt.xlim(0.25,3.00)
plt.ylabel(r'$\langle n_\uparrow n_\downarrow\rangle$', fontsize=30)
plt.xlabel(r'$\lambda_x/t$', fontsize=30)
#plt.grid(True)
plt.tight_layout()
#plt.show()

plt.savefig('double_f.png')
